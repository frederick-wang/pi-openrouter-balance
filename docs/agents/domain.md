...
When your output names a domain concept (in an issue title, a refactor proposal, a hypothesis, a test name), use the term as defined in `CONTEXT.md` (Limit bucket, Window, Used percent, Remaining percent, Window label, Active bucket, Snapshot, Freshness, Credits, Reset credit, Redeem request, Account identity, Account switch, Plan type, Rate limit reached type). Don't drift to synonyms the glossary explicitly avoids.
...
> _Contradicts ADR-0003 (one data source) — but worth reopening because…_
